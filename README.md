...
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- |
| 🟡 **Speech Detection после звонка** | После завершения звонка и начала нового может перестать работать зелёная обводка вокруг карточки говорящего. Связано с некорректным отключением детектора речи при разрыве P2P-соединения. | Обновить страницу (F5)        |
...
- [x] Обмен файлами
- [x] HTTPS поддержка
- [ ] 🖥️ Screen Sharing (демонстрация экрана)
